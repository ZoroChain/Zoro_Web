...
namespace WebBrowser
{
    export class GUI_Contract implements GUI_Base
    {
        ...
        putContract(div:HTMLDivElement){
            ...
            select.onchange = () => {
                if ((select.childNodes[select.selectedIndex] as HTMLOptionElement).value != "NEO"){
                    ...
                    CSSTool.handle_set(nativeNep5_lable);
                    $(nativeNep5_lable).addClass("switch-wrap");
                    nativeBackGround.appendChild(nativeNep5_lable);
        
                    var NativeNep5 = document.createElement('span') as HTMLSpanElement;
                    ...
                    CSSTool.flowRight_set(lable_nativeNep5);
                    lable_nativeNep5.style.marginRight = '373px';
                    nativeNep5_lable.appendChild(lable_nativeNep5);
        
                    var BoolNativeNep5 = document.createElement('input') as HTMLInputElement;
        ...
        createContract(contractBackGround:HTMLDivElement, select:HTMLSelectElement){
        ...
        createNativeContract(contractBackGround:HTMLDivElement, select:HTMLSelectElement){
            var nameTextModel = document.createElement("div");
            CSSTool.handle_set(nameTextModel);
            contractBackGround.appendChild(nameTextModel);
            ...
            CSSTool.handle_set(symbolTextModel);
            ...
            btnSend.onclick = async () => {           
                AppChainTool.SendNativeContract(Number(presion.value), totalSupply.value, symbol.value, name.value, 
