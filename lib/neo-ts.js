    ...
    var Uint160 = (function (_super) {
        ...
        function Uint160(value) {
            ...
            if (value.byteLength != 20)
                throw new RangeError();
            _this = _super.call(this, new Uint8Array(value)) || this;
            return _this;
        }
        ...
        Uint160.parse = function (str) {
            if (str.length != 40)
                throw new RangeError();
            var x = str.hexToBytes().reverse();
            return new Uint160(x.buffer);
        };
        return Uint160;
    }(Neo.UintVariable));
    Neo.Uint160 = Uint160;
...
var ThinNeo;
(function (ThinNeo) {
    var ZoroTransactionType;
    (function (ZoroTransactionType) {
        ZoroTransactionType[ZoroTransactionType["MinerTransaction"] = 0] = "MinerTransaction";
        ZoroTransactionType[ZoroTransactionType["IssueTransaction"] = 1] = "IssueTransaction";
        ZoroTransactionType[ZoroTransactionType["ClaimTransaction"] = 2] = "ClaimTransaction";
        ZoroTransactionType[ZoroTransactionType["EnrollmentTransaction"] = 32] = "EnrollmentTransaction";
        ZoroTransactionType[ZoroTransactionType["RegisterTransaction"] = 64] = "RegisterTransaction";
        ZoroTransactionType[ZoroTransactionType["ContractTransaction"] = 128] = "ContractTransaction";
        ZoroTransactionType[ZoroTransactionType["PublishTransaction"] = 208] = "PublishTransaction";
        ZoroTransactionType[ZoroTransactionType["InvocationTransaction"] = 209] = "InvocationTransaction";
    })(ZoroTransactionType = ThinNeo.ZoroTransactionType || (ThinNeo.ZoroTransactionType = {}));
    var ZoroTransactionAttributeUsage;
    (function (ZoroTransactionAttributeUsage) {
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["ContractHash"] = 0] = "ContractHash";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["ECDH02"] = 2] = "ECDH02";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["ECDH03"] = 3] = "ECDH03";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["Script"] = 32] = "Script";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["Vote"] = 48] = "Vote";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["DescriptionUrl"] = 129] = "DescriptionUrl";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["Description"] = 144] = "Description";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["Hash1"] = 161] = "Hash1";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["Hash2"] = 162] = "Hash2";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["Hash3"] = 163] = "Hash3";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["Hash4"] = 164] = "Hash4";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["Hash5"] = 165] = "Hash5";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["Hash6"] = 166] = "Hash6";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["Hash7"] = 167] = "Hash7";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["Hash8"] = 168] = "Hash8";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["Hash9"] = 169] = "Hash9";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["Hash10"] = 170] = "Hash10";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["Hash11"] = 171] = "Hash11";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["Hash12"] = 172] = "Hash12";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["Hash13"] = 173] = "Hash13";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["Hash14"] = 174] = "Hash14";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["Hash15"] = 175] = "Hash15";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["Remark"] = 240] = "Remark";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["Remark1"] = 241] = "Remark1";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["Remark2"] = 242] = "Remark2";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["Remark3"] = 243] = "Remark3";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["Remark4"] = 244] = "Remark4";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["Remark5"] = 245] = "Remark5";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["Remark6"] = 246] = "Remark6";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["Remark7"] = 247] = "Remark7";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["Remark8"] = 248] = "Remark8";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["Remark9"] = 249] = "Remark9";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["Remark10"] = 250] = "Remark10";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["Remark11"] = 251] = "Remark11";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["Remark12"] = 252] = "Remark12";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["Remark13"] = 253] = "Remark13";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["Remark14"] = 254] = "Remark14";
        ZoroTransactionAttributeUsage[ZoroTransactionAttributeUsage["Remark15"] = 255] = "Remark15";
    })(ZoroTransactionAttributeUsage = ThinNeo.ZoroTransactionAttributeUsage || (ThinNeo.ZoroTransactionAttributeUsage = {}));
    var ZoroAttribute = (function () {
        function ZoroAttribute() {
        }
        return ZoroAttribute;
    }());
    ThinNeo.ZoroAttribute = ZoroAttribute;
    var ZoroWitness = (function () {
        function ZoroWitness() {
        }
        Object.defineProperty(ZoroWitness.prototype, "Address", {
            get: function () {
                var hash = ThinNeo.Helper.GetScriptHashFromScript(this.VerificationScript);
                return ThinNeo.Helper.GetAddressFromScriptHash(hash);
            },
    ...
    ThinNeo.ZoroWitness = ZoroWitness;
    var ZoroInvokeTransData = (function () {
        function ZoroInvokeTransData() {
        }
        ZoroInvokeTransData.prototype.Serialize = function (trans, writer) {
            writer.writeVarBytes(this.script);
            writer.writeUint64(this.gasLimit.getData());
            writer.writeUint64(this.gasPrice.getData());
        };
        ZoroInvokeTransData.prototype.Deserialize = function (trans, reader) {
        ...
        return ZoroInvokeTransData;
    }());
    ThinNeo.ZoroInvokeTransData = ZoroInvokeTransData;
    var ZoroTransaction = (function () {
        function ZoroTransaction() {
        }
        ZoroTransaction.prototype.SerializeUnsigned = function (writer) {
            writer.writeByte(this.type);
            writer.writeByte(this.version);
        ...
        ZoroTransaction.prototype.Serialize = function (writer) {
            this.SerializeUnsigned(writer);
            var witnesscount = this.witnesses.length;
            writer.writeVarInt(witnesscount);
            for (var i = 0; i < witnesscount; i++) {
        ...
        ZoroTransaction.GetNonce = function () {
        ...
        ZoroTransaction.prototype.DeserializeUnsigned = function (ms) {
            if (ms.readByte() != this.type)
                throw "error";
            this.version = ms.readByte();
        ...
        ZoroTransaction.prototype.Deserialize = function (ms) {
            this.DeserializeUnsigned(ms);
            if (ms.canRead() > 0) {
                var witnesscount = ms.readVarInt();
                this.witnesses = [];
                for (var i = 0; i < witnesscount; i++) {
                    this.witnesses.push(new ThinNeo.Witness());
                    this.witnesses[i].InvocationScript = new Uint8Array(ms.readVarBytes()).clone();
                    this.witnesses[i].VerificationScript = new Uint8Array(ms.readVarBytes()).clone();
                }
            }
        };
        ZoroTransaction.prototype.GetMessage = function () {
            var ms = new Neo.IO.MemoryStream();
            var writer = new Neo.IO.BinaryWriter(ms);
            this.SerializeUnsigned(writer);
            var arr = ms.toArray();
        ...
        ZoroTransaction.prototype.GetRawData = function () {
            var ms = new Neo.IO.MemoryStream();
            var writer = new Neo.IO.BinaryWriter(ms);
            this.Serialize(writer);
            var arr = ms.toArray();
        ...
        ZoroTransaction.prototype.AddWitness = function (signdata, pubkey, addrs) {
            var vscript = ThinNeo.Helper.GetAddressCheckScriptFromPublicKey(pubkey);
            var sb = new ThinNeo.ScriptBuilder();
            sb.EmitPushBytes(signdata);
            var iscript = sb.ToArray();
        ...
        ZoroTransaction.prototype.AddWitnessScript = function (vscript, iscript) {
            var scripthash = ThinNeo.Helper.GetScriptHashFromScript(vscript);
            if (this.witnesses == null)
                this.witnesses = [];
            var newwit = new ThinNeo.Witness();
            newwit.VerificationScript = vscript;
            newwit.InvocationScript = iscript;
            for (var i = 0; i < this.witnesses.length; i++) {
                if (this.witnesses[i].Address == newwit.Address)
            ...
            _witnesses.sort(function (a, b) {
                var hash_a = ThinNeo.Helper.GetScriptHashFromScript(a.VerificationScript);
                var hash_b = ThinNeo.Helper.GetScriptHashFromScript(b.VerificationScript);
                for (var i_5 = (hash_a.length - 1); i_5 >= 0; i_5--) {
                    if (hash_a[i_5] > hash_b[i_5])
                        return 1;
                    if (hash_a[i_5] < hash_b[i_5])
                        return -1;
                }
        ...
        ZoroTransaction.prototype.GetHash = function () {
            var msg = this.GetMessage();
            var data = Neo.Cryptography.Sha256.computeHash(msg);
            data = Neo.Cryptography.Sha256.computeHash(data);
            return new Uint8Array(data, 0, data.byteLength);
        };
        return ZoroTransaction;
    }());
    ThinNeo.ZoroTransaction = ZoroTransaction;
})(ThinNeo || (ThinNeo = {}));
var ThinNeo;
(function (ThinNeo) {
    var OpCode;
